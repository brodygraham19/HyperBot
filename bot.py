...
# NEW ping test command
@bot.tree.command(name="ping", description="Check if HyperBot is active")
async def ping(interaction: discord.Interaction):
    await interaction.response.send_message("🏓 Pong! HyperBot is online.", ephemeral=True)
